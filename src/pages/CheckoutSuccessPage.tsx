...
const CheckoutSuccessPage = () => {
  ...
  return (
    <>
      ...
      <meta
        name="description"
        content="Congratulation on your successful purchase, please check your inbox for the summary"
      />
      <section
      ...
      >
        <div
          className="card shadow-sm border-0 p-5 text-center bg-white"
          style={{ maxWidth: 420 }}
        >
          <div className="mb-4">
            <i
          ...
          <h1
            className="fw-bold mb-3 text-body"
            style={{ color: 'var(--color-text-heading)' }}
          >
            Thank you for your purchase!
          </h1>
          <p className="mb-4 text-muted">
            Your order was successful. You will receive a confirmation email
            soon.
          </p>
          <button
